            ...
            public void run() {
                ...
                try  {
                    try {
                        ...
                        //url = new URL("http://fasttransfer.com.mx:8080/inserta?imei="+imei+"&valores="+valores+"&pila="+bateria);

                        url = new URL("http://fasttransfer.com.mx:8080/api/gps/"+imei+"/"+valores+"/"+bateria);
